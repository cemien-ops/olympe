...
function renderAvatar(avatar, size = "24px") {
  ...
  if (typeof avatar === "string" && (avatar.startsWith("data:") || avatar.startsWith("http"))) {
    return <img src={avatar} alt="" onError={e => { e.target.onerror = null; e.target.src = AVATAR_FB; }} style={{ width: size, height: size, borderRadius: "50%", objectFit: "cover", verticalAlign: "middle" }} />;
  }
  return avatar;
}
